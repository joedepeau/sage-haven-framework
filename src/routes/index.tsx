          ...
          <div className="grid gap-12 sm:grid-cols-1 md:grid-cols-2 md:gap-16 lg:gap-24">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="border-t border-b border-navy/10 py-6">
                <p className="font-body text-base leading-relaxed text-slate sm:text-lg">
                  Worked with microdosing before, and want to develop it into a deeper and more impactful practice in your daily life?
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { title: "Science + Tradition", desc: "We are informed by both research and time-honoured wisdom" },
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
            {[
              ...
              {
                text: "\"I have worked with Joe for a few years and have always found him to be consistent, dependable, trustworthy, and knowledgeable. I have also always appreciated how calm, composed, perceptive, and level-headed he is. He is someone I would always turn to for help and support.\"",
                name: "Sandy A.",
                info: "She/Her - France"
              }
            ].map((testimonial, i) => (
