    ...
    <div className="min-h-screen bg-cream">
          ...
          <div className="grid items-start gap-12 md:grid-cols-5 md:gap-16 lg:gap-20">
            ...
            <div className="flex flex-col justify-center md:col-span-3">
              ...
              <p className="mt-6 font-body text-base leading-relaxed text-slate sm:text-lg">
                My coaching style is calm, steady, supportive, and considered - with a touch of humour and lightness when appropriate.&nbsp; I like to mix modalities like breathwork, visualisation, and movement practices into coaching sessions to create opportunities for holistic transformation and integration.
              </p>
      ...
      <section className="px-6 py-20 sm:px-8 sm:py-28 lg:px-12 lg:py-36">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 font-body text-base leading-relaxed text-slate sm:text-lg">
            Everything shared within our sessions is held in strict confidentiality. My role is to serve as a steady co-navigator, offering considered perspectives and practical tools without judgment or agenda. The container we build is one of safety, self-care, and mutual respect - so you can show up fully, explore honestly, and move forward with clarity.
          </p>
        </div>
      </section>
